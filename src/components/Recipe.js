...
class Recipe extends Component {
  ...
  handleReport() {
    ...
    axios
      .post(`${this.serverUrl}/blacklist`, postBody, {
        headers: {
      ...
      <Grid contuner item>
        ...
        >
          ...
          <CardContent>
            ...
            {addedByUser ? (
              <PersonalRecipeData {...this.props}> </PersonalRecipeData>
            ) : null}
            <Typography
              variant="body2"
              color="text.primary"
            ...
            <Grid
              container
              columnSpacing={{ aglinContent: "center", xs: 12, sm: 4, md: 6 }}
            >
              <Grid item xs={5}>
                <Select
              ...
              <Grid item xs={2}>
                <Select
                  sx={{ fontSize: "12px", width: 100, height: 30 }}
                  labelId="hour-label"
                  id="hour"
